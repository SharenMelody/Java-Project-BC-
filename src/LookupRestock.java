 ...
 * @author Asus
 */
public class LookupRestock extends javax.swing.JDialog {
     ...
     */
    public LookupRestock(javax.swing.JPanel parent, boolean modal) {
        initComponents();
    ...
    private void tblLookupMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblLookupMouseClicked
        if (lblLookup.getText().equals("Daftar Produk")) {
            Stock.txtStRestock.setText(tblLookup.getValueAt(tblLookup.getSelectedRow(),0).toString());
            Stock.txtPetugas_id.setText(tblLookup.getValueAt(tblLookup.getSelectedRow(),1).toString());
            Stock.txtVendorId.setText(tblLookup.getValueAt(tblLookup.getSelectedRow(),2).toString());
        }
